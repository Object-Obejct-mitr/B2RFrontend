    ...
    methods: {
        async updateDBQuantity() {
            let documentCollection = collection(
                db,
                "ProgressViewTasks/" + this.data.CatID + "/" + this.data.Status
            );
    ...
    <div id="accordionPanelsStayOpen" class="accordion accordion-flush grab">
        <div class="accordion-item">
            <div
                ...
                :class="[
                    isMobile()
                        ? 'flex-column align-content-center text-center'
                        : 'flex-row',
                ]"
            >
                <div
                    class="d-flex flex-row text-wrap"
            ...
            >
                <div
                    class="accordion-body d-flex justify-content-around"
